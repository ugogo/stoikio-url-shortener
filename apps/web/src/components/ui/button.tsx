  ...
  const defaultProps = {
    ...
    children: (
      <>
        ...
        {loading && (
          <Spinner
            className="pointer-events-none absolute transition-[opacity,scale,filter] duration-150 ease-[cubic-bezier(0.2,0,0,1)] starting:scale-25 starting:opacity-0 starting:blur-[4px] motion-reduce:transition-none"
